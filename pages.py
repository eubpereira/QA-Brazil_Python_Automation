...
class UrbanRoutesPage:
    ...
    code_card = (By.XPATH,"//input[@id='code' and contains(@class, 'card-input')]")
    ...
    # Comentário e cobertor
    add_comment = (By.ID, 'comment')
    switch_blanket = (By.CSS_SELECTOR, '.switch')
    switch_blanket_active = (By.CSS_SELECTOR, '#root div.reqs-body div:nth-child(1) input')
